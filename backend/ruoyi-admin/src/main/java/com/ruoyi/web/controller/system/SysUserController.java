...
public class SysUserController extends BaseController {
    ...
    @PreAuthorize("@ss.hasPermi('system:user:init')")
    @PutMapping("/changeAllUserStatus")
    public AjaxResult changeAllUserStatus(@RequestParam String status) {
        return toAjax(userService.updateAllUserStatus(status));
    }

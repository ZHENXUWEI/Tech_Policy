      ...
      <el-col :span="1.5">
        ...
        >
          ...
          <span slot="footer" class="dialog-footer">
            ...
            <el-button type="primary" @click="checkPassword">下一步</el-button>
          </span>
        </el-dialog>
...
export default {
  ...
  methods: {
    ...
    //   const minDuration = new Promise((resolve) => setTimeout(resolve, 3000)); // 至少等3秒
    ...
    // },
    checkPassword() {
      if (this.passwordInput.trim() === this.accessPassword) {
    ...
    updateAllUserStatus(status) {
      changeAllUserStatus(status).then((res) => {
        if (res.code == "200") {
          this.getList();
          this.showInitDialog = false;
          this.$message({
